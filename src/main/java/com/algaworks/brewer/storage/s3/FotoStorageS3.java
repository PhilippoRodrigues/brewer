...
public class FotoStorageS3 implements FotoStorage {
    ...
    public byte[] recuperar(String foto) {
        ...
        try{
            ...
            logger.error("Erro ao recuperar foto do S3", e);
        }
        return null;
    }
    ...
    public String getUrl(String foto) {
        ...
        if (!StringUtils.isEmpty(foto))
            return "https://awsbrewer.s3-sa-east-1.amazonaws.com/" + foto;

        return null;
    }

    private ObjectMetadata enviarFoto(
            String novoNome, MultipartFile arquivo, AccessControlList acl) throws IOException {
        //Metadata para a imagem
