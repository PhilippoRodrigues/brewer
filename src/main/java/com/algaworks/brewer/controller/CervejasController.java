...
public class CervejasController {
	...
	public ModelAndView salvar(@Valid Cerveja cerveja,
	...
	public ModelAndView pesquisar(CervejaFilter cervejaFilter, BindingResult result
		...
		PageWrapper<Cerveja> paginaWrapper = new PageWrapper<>(cervejas.filtrar(
				cervejaFilter, pageable), httpServletRequest);
